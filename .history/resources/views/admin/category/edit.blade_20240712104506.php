...
<form action="{{route('category.store')}}" method = 'post' role="form">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" value="{{$category->name}}" name='name' id="exampleInputEmail1" aria-describedby="emailHelp">
    ...
    <div class="mb-3">
      ...
      <div class="radio">
        <label for="">
            <input type="radio" name="status" value="0" {{$category->status == 1 ? 'checked' : ''}}>
            Tam an
        </label>
      </div>
    </div>
